...
import sys
sys.path.append("..")
from toolkit.util.pre_load import neo_con
from toolkit.util.pre_load import wv_model, tree, predict_labels
from toolkit.util.NER import get_explain, get_detail_explain
